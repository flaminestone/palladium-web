...
export class PalladiumApiService {
  ...
  getProjects(): Observable<Project[]> {
    return this.http.post<{"products": Project[]}>('/api/products', null).pipe(delay(1000), map(data => {
  ...
  // //#region Products
  // get_projects() {
  //   return this.http.post(this.environment.host + '/products', '').pipe(map((response) => {
  //     console.log(response)
  //     return response;
  //   }));
  // }
